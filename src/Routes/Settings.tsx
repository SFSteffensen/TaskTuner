  ...
  return (
    <div class="overflow-x-auto p-4">
      ...
      <div class="join join-vertical w-full">
                  ...
                  <div class="stats shadow">
                    <div class="stat bg-base-200">
                      ...
                      <div class="stat-value">
                        {absenceData()["Samlet"].opgjort.procent}
                      </div>
                      <div class="stat-desc text-secondary">
                        {absenceData()["Samlet"].opgjort.moduler} moduler
                      </div>
                    </div>
                    <div class="stat bg-base-200">
                      <div class="stat-title">For Året</div>
                      <div class="stat-value">
                        {absenceData()["Samlet"].for_the_year.procent}
                      </div>
                      <div class="stat-desc text-secondary">
                        {absenceData()["Samlet"].for_the_year.moduler}
                      </div>
                    </div>
                  </div>
                ) : (
                ...
                absenceData()["Samlet"].writing ? (
                  <div class="stats shadow">
                    <div class="stat bg-base-200">
                      <div class="stat-title">Opgjort</div>
                      <div class="stat-value">
                        {absenceData()["Samlet"].writing.opgjort.procent}
                      </div>
                      <div class="stat-desc text-secondary">
                        {absenceData()["Samlet"].writing.opgjort.moduler}{" "}
                        moduler
                      </div>
                    </div>
                    <div class="stat bg-base-200">
                      ...
                      <div class="stat-value">
                        {
                          absenceData()["Samlet"].writing.for_the_year_wrting
                            .procent
                        }
                      </div>
                      <div class="stat-desc text-secondary">
                    ...
                    if (team !== "Samlet") {
                      return (
                        <div class="stat place-items-center" key={team}>
                          ...
                          <div class="stat-value">
                            {details.opgjort.procent}
                          </div>
                          <div class="stat-desc text-secondary">
                            {details.opgjort.moduler}
                          </div>
                          <div class="stat-value">
                            {details.for_the_year.procent}
                          </div>
                          <div class="stat-desc text-secondary">
                            {details.for_the_year.moduler}
                          </div>
                        </div>
                      );
                    }
        ...
        <div class="collapse collapse-arrow join-item border border-base-300">
          <input type="radio" name="my-accordion-1" />
          <div class="collapse-title text-xl font-medium">Dokumenter</div>
        ...
        <div class="collapse collapse-arrow join-item border border-base-300">
          <input type="radio" name="my-accordion-1" />
          <div class="collapse-title text-xl font-medium">Karakterer</div>
          <div class="collapse-content">
              ...
              <table class="table table-xs md:table-sm lg:table-md xl:table-lg w-full table-compact table-fixed whitespace-normal">
                  ...
                  {gradesData().grades.map((grade, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        {grade.second_standpoint?.weight && (
                          <div class="text-xs opacity-50">
                            {grade.second_standpoint.weight}
                          </div>
                        )}
                ...
                <tfoot>
                  <tr>
                    ...
                    <td class="hidden md:table-cell">
                      {calculateAverage(gradesData().grades, "internal_exam")}
                    </td>
                    <td>
                      {calculateAverage(gradesData().grades, "final_exam")}
                    </td>
                  </tr>
                </tfoot>
              </table>
